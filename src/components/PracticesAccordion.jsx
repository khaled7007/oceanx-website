    ...
    <div className="border-b border-gray-100">
      ...
      >
        <div className="flex items-center gap-5">
          ...
          <span className="text-gray-400 text-sm font-light hidden sm:block">
            {practice.titleEn}
          </span>
        </div>
          ...
          >
            <div className="pb-8 pr-11">
              <div className="grid lg:grid-cols-[2fr_1fr] gap-8 items-start">
                <div>
                  <p className="text-gray-500 font-light leading-[1.85] text-[15px] mb-3">
                    {practice.description}
                  </p>
                  <p className="text-gray-400 font-light leading-[1.85] text-[14px]">
                    {practice.subtitle}
                  </p>
                </div>
                <div className="flex flex-wrap gap-2 lg:justify-end">
                  {practice.accordion?.map((s) => (
                    <span
                      key={s.label}
                      className="text-xs bg-gray-50 border border-gray-100 text-gray-500 px-3 py-1.5 rounded-full"
                    >
                      {s.label}
                    </span>
                  ))}
